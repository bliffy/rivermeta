...
static inline int bloomfilter_resize(
          bloomfilter_t* bf,
          uint8_t rnds,
          uint8_t size)
{
...
static inline bloomfilter_t* bloomfilter_init(
          uint8_t rounds,
          uint8_t bit_size)
{
...
static inline uint32_t bloomfilter_getmapwords(
          bloomfilter_t* bf)
...
static inline bloomfilter_t* bloomfilter_import(
          const char * filename)
{
     FILE* fp;
...
static inline int bloomfilter_export(
          bloomfilter_t* bf,
          const char* filename)
{ /* export BF to file */
     if (!bf->bits) {
...
static inline int bloomfilter_export_reduce(
          bloomfilter_t* bf,
          const char* filename,
          uint32_t bit_reduce)
{
...
static inline int bloomfilter_export_autoreduce(
          bloomfilter_t* bf,
          const char* filename)
{
...
static inline int bf_query_hvals(
          bloomfilter_t* bf,
          uint32_t* hvals)
{
     if (!bf->bits) return 0;
...
static inline int bloomfilter_query(
          bloomfilter_t* bf,
          uint8_t* key,
          uint32_t len)
{
...
static inline int bf_set_hvals(
          bloomfilter_t* bf,
          uint32_t* hvals)
{
     if (!bf->bits) return 0;
...
static inline int bloomfilter_set(
          bloomfilter_t * bf,
          uint8_t* key,
          uint32_t len)
{
